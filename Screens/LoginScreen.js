  ...
  async function signInWithGoogleAsync() {
    try {
      const result = await Google.logInAsync({
        ...
        androidClientId:
          "582689956270-o2f3is5oiedos03icv83uv3nuji2d6o8.apps.googleusercontent.com", // replace this with your own
        iosClientId:
          "582689956270-32a7png3rit2g13snvbj0jli0l2mv2ib.apps.googleusercontent.com", // replace this with your own
      ...
      >
        ...
        <View style={styles.inputContainer}>
          ...
          <Button
            ...
            onPress={login}
          /> */}
          {/* <Text style={{  paddingBottom: 4, fontSize: 20, fontWeight:"semibold" }}>Sign In with:</Text> */}
          {/* <Button

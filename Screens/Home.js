    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        {/* <View style={styles.footer}>
          ...
          />
          <TouchableOpacity onPress={() => alert("sample")} activeOpacity={0.5}>
            <AntDesign name="search1" size={24} color="purple" />
          </TouchableOpacity>
        </View> */}
                    ...
                    {item[4].includes(hobby) ? (
                      <View>
                        <View style={styles.itemContainer}>
                          ...
                          <Text style={styles.item}>{item?.[3]} km away</Text>
                        </View>
                      </View>
                    ) : null}
                  </TouchableOpacity>
